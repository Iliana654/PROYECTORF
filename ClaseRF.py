        ...
        for caracodif, caraubic in zip(cara_captura_codificada, cara_captura):
            ...
            if True in coincidencias:
                ...
                if distancias[indice_coincidencia] <= 0.6:
                    ...
                    imagen_reconocida = cv2.putText(imagen_reconocida, f"Bienvenida {nombre_empleado}",
                    ...
                    imagen = cv2.putText(imagen, f"Bienvenida {nombre_empleado}",
                    ...
                    #Mostrar las dos imagenes juntas en una sola ventana
                    ...
                    cv2.imshow("Comparación", imagenComb)
                    cv2.waitKey(0)
                    cv2.destroyAllWindows()
